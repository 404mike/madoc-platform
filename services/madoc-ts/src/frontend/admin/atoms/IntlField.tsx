...
const IntlInputContainer = styled.div`
  background: #fff;
  border: 2px solid #999;
`;

const IntlInputDefault = styled.div`
  display: flex;
`;

const IntlInput = styled.input`
  flex: 1 1 0px;
  background: #fff;
  border: none;
  padding-left: 0.4em;
...
const IntlInputButton = styled.button`
  background: #fff;
  border: none;
  padding: 0.4em 0.8em;
  width: 4em;
...
const IntlInputEditLanguage = styled.input`
  background: #fff;
  border: none;
  padding: 0.4em 0.8em;
  width: 4em;
...
const IntlInputExtraInput = styled.div`
  & ${IntlInputDefault} {
